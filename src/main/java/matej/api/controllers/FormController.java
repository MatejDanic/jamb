...
public class FormController {
	...
	public Column getColumnByType(@PathVariable(value="id") int id, @PathVariable(value="columnTypeOrdinal") int columnTypeOrdinal) {
	...
	public Set<Box> getColumnBoxes(@PathVariable(value="id") int id, @PathVariable(value="columnTypeOrdinal") int columnTypeOrdinal) {
	...
	public Box getColumnBoxByType(@PathVariable(value="id") int id, @PathVariable(value="columnTypeOrdinal") int columnTypeOrdinal, @PathVariable(value="boxTypeOrdinal") int boxTypeOrdinal) {
