...
//	var url = 'https://jamb-remote.herokuapp.com/forms/' + formId + '/roll';
	var url = 'localhost:8080/forms/' + formId + '/roll';
...
//			console.log(http.responseText)
			var numbers = JSON.parse(http.responseText);
...
//				console.log(obj);
	...
	for (var i = 0; i < diceButtons.length; i++) {
		if (diceButtons[i].style.backgroundColor == "rgb(220, 220, 220)") {
			...
			$(diceButtons[i]).html('<img src="../images/dice/' + diceValue[i] + '.bmp">');
			diceButtons[i].value = diceValue[i];
		}
	}
...
//		chargeURLPut('https://jamb-remote.herokuapp.com/scores/'+formId);
...
//	if (nickname != null && nickname != "") {
//		var xmlHttp = new XMLHttpRequest();
//		chargeURLPut('https://jamb-remote.herokuapp.com/scores/finish/'+formId);
//
//		function chargeURLPut(url) { 
//			var mimeType = "text/plain";  
//			xmlHttp.open('PUT', url, true);
...
function showLeaderboard() {
	...
	var url = 'localhost:8080/scores/leaderboard';
...
//		location.href='https://jamb-remote.herokuapp.com/scores';
		location.href='localhost:8080/scores'
	}
