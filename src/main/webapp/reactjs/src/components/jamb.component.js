...
export default class Jamb extends Component {
    render() {
        return (
            ...
            <img className="label-image" src="@{/images/field/downwards.bmp}" /> <img className="label-image" src="@{/images/field/upwards.bmp}" /> <img className="label-image" src="@{/images/field/any_direction.bmp}" />
            <div className="label">NAJAVA</div>
            <div className="empty-item" />
            <img className="label-image" src="@{/images/dice/1.bmp}" />
            ...
            <div className="empty-item" />
            <img className="label-image" src="@{/images/dice/2.bmp}" />
            ...
            <div className="empty-item" />
            <img className="label-image" src="@{/images/dice/3.bmp}" />
            ...
            <div className="empty-item" />
            <img className="label-image" src="@{/images/dice/4.bmp}" />
            ...
            <div className="empty-item" />
            <img className="label-image" src="@{/images/dice/5.bmp}" />
            ...
            <div className="empty-item" />
            <img className="label-image" src="@{/images/dice/6.bmp}" />
